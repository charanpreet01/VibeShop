    ...
    <div>
      ...
      <div className="my-10 flex flex-col justify-center md:flex-row gap-10 mb-28">
        ...
        <div className="flex flex-col justify-center items-start gap-6">
          ...
          <p className='text-gray-500'>123 Golden Avenue <br />
            Near Amritsar Railway Station <br />
            Amritsar, Punjab 143001 <br />
            India</p>

          <p className='text-gray-500'>
            Tel: +91-987-654-3210 <br />
            Email: contact@vibeshop.com
          </p>

          <p className='font-semibold text-xl text-gray-600'>Careers at VibeShop</p>
